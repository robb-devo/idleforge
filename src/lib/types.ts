...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  wallets: [
    ...
    {
      id: "xmr-gpu",
      label: "XMR GPU (dieselbe Empfangsadresse)",
      coin: "XMR",
      receive_address: "YOUR_XMR_RECEIVE_ADDRESS_HERE",
  ...
  gpu: {
    ...
    algorithm: "ETCHASH",
    algorithm_note:
      "ETCHASH über MoneroOcean — Auszahlung in XMR auf dieselbe Empfangsadresse. Algorithmus bleibt austauschbar.",
    binary_path: "C:\\Miners\\lolMiner\\lolMiner.exe",
    api_port: 18089,
    pool: {
      url: "gulf.moneroocean.stream:20128",
      tls: true,
      user_template: "{address}",
      pass: "worker~etchash",
    },
    extra_args: [],
  },
